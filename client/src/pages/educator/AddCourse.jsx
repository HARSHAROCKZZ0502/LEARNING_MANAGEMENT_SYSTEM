...
const handleSubmit=async (e) => {
  ...
  return (
            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4 '>
              <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                 ...
                 <span className='text-gray-500'>{chapter.chapterContent.length === 1
    ? '1 lecture'
    : `${chapter.chapterContent.length} lectures`}</span>
         ...
         <button type='submit'  className='bg-black text-white w-max py-2.5 px-8 rounded my-4' onClick={() => {
    const title = document.getElementById('courseTitle').value;
    const thumb = document.getElementById('courseThumbnail').value;
